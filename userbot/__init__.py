import os ; import sys ; from pymongo import MongoClient ; from telethon.sessions import StringSession ; from telethon import TelegramClient ;bfrom teletho.tl.types import PeerChannel ; borg = bot ; from var import Var ; import time ; UpTime = time.time()
